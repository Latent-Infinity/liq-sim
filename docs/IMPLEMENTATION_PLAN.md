...
## Stage 0 – Groundwork (Commit-ready)
...
## Stage 1 – Contracts & Validation (Commit-ready)
...
## Stage 2 – Accounting Core (Commit-ready)
...
## Stage 3 – Provider Models v1 (Coinbase & Robinhood) (Commit-ready)
...
## Stage 4 – Execution Loop & Orders (Commit-ready)
...
## Stage 5 – Constraints & Kill Switches (Commit-ready)
...
## Stage 6 – Provider Models v2 (Oanda & Tradestation) (Commit-ready)
...
## Stage 7 – Checkpointing & Determinism (Commit-ready)
...
## Stage 8 – Outputs & Integration Hooks (Commit-ready)
...
## Stage 9 – Golden Sets & Coverage (Commit-ready)
